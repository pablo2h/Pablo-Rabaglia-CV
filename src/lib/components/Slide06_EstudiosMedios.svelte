<!--
  ...
  - Basado en "Estudios 3 nedios .png": lista de estudios intermedios.
  - Contenedor a pantalla completa centrado y lista con estilos de tarjeta.
-->
<div class="flex flex-col items-center justify-center h-screen p-4 text-center">
  <h2 class="font-display text-4xl mb-8">Mis estudios medios:</h2>
